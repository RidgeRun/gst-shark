...
public class GstSharkFrameRateView extends TmfChartView {


	private static final String EVENT_NAME = "framerate";
	private static final String PLOT_NAME = "Frame Rate";
    private static final String Y_AXIS_TITLE = "Frame Rate (fps)";
    private static final String X_AXIS_TITLE = "Event time";
    private static final String VIEW_ID = "com.ridgerun.gstshark.framerate";
    private ITmfTrace currentTrace;

    public GstSharkFrameRateView() {
        super(VIEW_ID);
    }
	...
	protected TmfXYChartViewer createChartViewer(Composite arg0) {
		...
		return new GstSharkFrameRate(arg0,PLOT_NAME, X_AXIS_TITLE, Y_AXIS_TITLE,EVENT_NAME);
	}
